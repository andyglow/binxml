...
public class LittleEndianDataInputStream extends FilterInputStream implements DataInput {
	 ...
	 * actually read is returned as an integer. This method blocks until input
	 * data is available, end of file is detected, or an exception is thrown.
	 * 
	 * <p>
	 * If <code>b</code> is null, a <code>NullPointerException</code> is
	 * thrown. If the length of <code>b</code> is zero, then no bytes are read
	 * and <code>0</code> is returned; otherwise, there is an attempt to read
	 * at least one byte. If no byte is available because the stream is at end
	 * of file, the value <code>-1</code> is returned; otherwise, at least one
	 ...
	 * most, equal to the length of <code>b</code>. Let <code>k</code> be
	 ...
	 * <code>b[off]</code> through <code>b[off+</code> <i>k </i>
	 * <code>-1]</code>, leaving elements <code>b[off+</code> <i>k </i>
	 ...
	 * characters is then returned as a <code>String</code>. The details of
	 ...
	 *                if an I/O error occurs.
	 * @exception UTFDataFormatException
	 *                if the bytes do not represent a valid Java modified UTF-8
