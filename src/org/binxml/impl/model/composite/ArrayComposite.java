 ...
 * @since on 22.06.2004
 */
public class ArrayComposite implements IComposite {

    private IExternalizable[] data = new IExternalizable[0];
    ...
    public int indexOf(IExternalizable obj) {
        return ArrayUtil.indexOf(data, obj);
    }
    ...
    public void put(IExternalizable obj) {
        ...
        if (!ArrayUtil.contains(data, obj)) {
            data = (IExternalizable[]) ArrayUtil.push(data, obj);
        }
    }
